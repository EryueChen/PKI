    ...
    private void init() throws Exception {
		...
		jb1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event){
						...
						jtf9.getText().isEmpty() || jtf10.getText().isEmpty())
				{
					...
					info.setText("密码位数小于6，请您重新输入密码！");
					JOptionPane.showMessageDialog(null, "密码位数小于6，请您重新输入密码！", "提示", JOptionPane.OK_OPTION);
				}
				else if(!jtf10.getText().matches("[0-9]+")){
					info.setText("有效期需要输入正整数！");
					JOptionPane.showMessageDialog(null, "有效期需要输入正整数！", "提示", JOptionPane.OK_OPTION);
				}else{
					...
					JOptionPane.showMessageDialog(null,"证书已申请成功","证书申请",JOptionPane.OK_OPTION);
				}
			}
		});
        jPanel1.add(jb2);
		jb2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event){
				 ...
				 * 
				 */
				String aliasstr = JOptionPane.showInputDialog("请输入证书别名（alias）");
				...
				JOptionPane.showMessageDialog(null,"证书已导出","证书导出",JOptionPane.OK_OPTION);
			}
		});
